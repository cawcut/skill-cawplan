...
/** `POST /qa/testrail/suites` business codes (contract §1.3). */
export const API_CODE_SUITE_CREATE_RATE_LIMITED = "SUITE_CREATE_RATE_LIMITED";
export const API_CODE_SUITE_MODE_NOT_SUPPORTED = "SUITE_MODE_NOT_SUPPORTED";
...
const TESTRAIL_CODES = new Set([
  ...
  API_CODE_SUITE_CREATE_RATE_LIMITED,
  API_CODE_SUITE_MODE_NOT_SUPPORTED,
]);
